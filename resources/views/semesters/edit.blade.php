...
@section('content_header')
    <div class="semester-form-header">
        <div>
            <h1 class="semester-form-title">Edit Semester</h1>
        </div>
        <div>
    ...
    <div class="card semester-form-card">
        <div class="card-header semester-form-card-header">
            <h3 class="card-title semester-form-card-title">
                <i class="fas fa-edit mr-2"></i> Semester Information
            </h3>
        </div>
            ...
            <form action="{{ route('semesters.update', $semester->id) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('school_year', $semester->school_year) }}"
                            >
                            @error('school_year')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                ...
                <div class="semester-form-actions">
                    <button type="submit" class="btn btn-semester-save">
                        <i class="fas fa-save mr-1"></i> Update Semester
                    </button>
